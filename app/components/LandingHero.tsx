...
function MobileSlider() {
    ...
    const startAuto = () => {
        ...
        autoRef.current = setInterval(() => setCurrent((p) => (p + 1) % total), 3200);
    };
    ...
    const onTouchEnd = () => {
        if (dragOffset < -40) goTo(current + 1);
        else if (dragOffset > 40) goTo(current - 1);
...
export default function Hero() {
    return (
        <>
            ...
            {/* ── MOBILE: full screen slider only ── */}
            <MobileSlider />
                        ...
                        {stats.map((s, i) => (
                            ...
                            >
                                ...
                                <div>
                                    ...
                                    <p className="mt-0.5 text-[10px] lg:text-[12px]" style={{ color: "#64748b" }}>
                                        {s.label}
                                    </p>
                                </div>
                            </div>
