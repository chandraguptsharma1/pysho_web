        ...
        <header className="sticky top-0 z-50 border-b border-slate-100 bg-white/95 backdrop-blur">
            ...
            <div className="mx-auto flex h-[72px] max-w-7xl items-center justify-between px-6 lg:px-10">
                ...
                <Link href="/" className="flex items-center gap-3 no-underline">
                    <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-blue-700 shadow-md shadow-blue-200">
                    ...
                    <div>
                        <h2 className="text-[18px] font-bold leading-none tracking-tight">
                            <span className="text-blue-700">Psycho</span>
                            <span className="text-slate-800">Scan</span>
                        </h2>
                        <p className="mt-0.5 text-[10px] font-medium uppercase tracking-[1.5px] text-slate-400">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <a href="tel:08045816232"
                        className="hidden items-center gap-2 rounded-lg border border-slate-200 px-4 py-2 text-sm font-medium text-slate-600 transition hover:border-blue-200 hover:text-blue-700 lg:flex"
                    >
                    ...
                    <Link
                        href="/contact"
                        className="rounded-lg bg-blue-700 px-5 py-2.5 text-sm font-semibold text-white shadow-md shadow-blue-200 transition hover:bg-blue-800"
                    >
                        Send Inquiry
                    </Link>
                </div>
