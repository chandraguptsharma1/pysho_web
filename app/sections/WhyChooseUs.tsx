            ...
            <div className="mx-auto max-w-6xl px-6 lg:px-10">
                ...
                <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
                    {reasons.map((r) => (
                        ...
                        >
                            {/* Left accent */}
                            <div className="absolute bottom-0 left-0 top-0 w-1 rounded-l-2xl bg-blue-700" />

                            {/* Background number */}
                            <span className="absolute right-5 top-4 text-4xl font-bold leading-none text-blue-50 select-none">
                                {r.num}
                            </span>
                            ...
                            <h3 className="mb-2 text-[15px] font-semibold text-slate-900">{r.title}</h3>
                            <p className="text-[13px] leading-relaxed text-slate-500">{r.text}</p>
                        </div>
                    ))}
                </div>
            </div>
