            ...
            <div className="mx-auto max-w-6xl px-6 lg:px-10">
                ...
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
                    {buyers.map((b) => (
                        <div
                            key={b.title}
                            className="rounded-2xl border border-slate-200 bg-white p-6 text-center transition hover:shadow-md hover:shadow-blue-50"
                        >
                            <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-xl bg-blue-50">
                                {b.icon}
                            </div>
                            <h3 className="mb-1.5 text-sm font-semibold text-slate-900">{b.title}</h3>
